...
function App() {
  ...
  const findIntersection = (line1, line2) => {
    ...
    function intersect(line11, line22) {
      return ccw(line11[0], line22[0], line22[1]) !== ccw(line11[1], line22[0], line22[1]) && ccw(line11[0], line11[1], line22[0]) !== ccw(line11[0], line11[1], line22[1])
    }
    ...
    if (calcDistance(line2[0], line1[0]) + calcDistance(line2[1], line1[0]) === calcDistance(line2[0], line2[1])) {
      return null
    }
